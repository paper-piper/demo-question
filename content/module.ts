...
const PRINCIPLES_LIST: Block[] = [
  {
    type: 'list',
    items: [
      'זכות התכנון: לילד יש זכות מלאה לתכנן את זמנו בבית הספר ולבחור מה וכיצד ללמוד.',
      'אין חובת למידה פורמלית של מקצועות ליבה או קורסים כלשהם.',
      'הזכות לבחור קיימת עבור כלל הילדים בקהילה כבר מגיל הגן.',
      ...
      'בית הספר רואה בפרט חלק מקהילה. לצד מימוש עצמי, המערכת שמה דגש על למידה פלורליסטית, קבלת האחר ושמירה על זכויות הזולת במרחב הציבורי.',
    ],
  },
];

const MENTORING_LIST: Block[] = [
  {
    type: 'list',
    items: [
...
export const UNITS: Unit[] = [
  {
    id: 'unit-1',
    number: 1,
    title: 'יחידה 1: למידה, בחירה ואחריות',
    icon: 'compass',
    ...
    slides: [
      {
        ...
        blocks: [
          {
            type: 'paragraph',
            text: 'בית הספר הדמוקרטי רואה באדם את מרכז הקיום, ובו-זמנית שותף ליצירת קהילה אנושית המאפשרת לכל חבריה מימוש וביטוי עצמי. לכן, נקודת המוצא של החיים בבית הספר מתחילה בבחירה שלכם. ביחידה זו נכיר את הלב הפועם של הלמידה אצלנו - הריבונות של הילד על הזמן שלו.',
          },
          ...PRINCIPLES_LIST,
        ],
      },
      {
        kind: 'quiz',
        id: 'u2-a1',
        heading: 'יחידה 1: חידון דילמות "בונים מערכת"',
  ...
  },
  {
    id: 'unit-2',
    number: 2,
    title: 'יחידה 2 - תפקיד החונך והקבוצה החברתית',
    icon: 'people',
    ...
    slides: [
      {
        ...
        blocks: [
          {
            type: 'paragraph',
            text: "חופש הבחירה שפגשנו ביחידה הקודמת יכול לעורר שאלות וחששות: 'איך לא הולכים לאיבוד בתוך כל החופש הזה?'. כאן נכנס לתמונה החונך האישי - המלווה שלכם במסע, לצד קבוצת השייכות שלכם - ה'בית'.",
          },
          {
            type: 'paragraph',
      ...
      },
      {
        kind: 'match',
        id: 'u3-a1',
        heading: 'יחידה 2: משחק התאמה – מודל החונכות',
  ...
  },
  {
    id: 'unit-3',
    number: 3,
    title: 'יחידה 3 - רשויות, חופש וגבולות',
    icon: 'scales',
    ...
    slides: [
      {
        ...
        blocks: [
          {
            type: 'paragraph',
            text: 'עד כה הכרנו את מרחב הבחירה האישי ואת הליווי הצמוד של החונך. אך כיצד המבנה הדמוקרטי של בית הספר מגן על חופש הפרט בתוך קהילה של מאות אנשים? ביחידה זו נלמד על חופש בתוך גבולות.',
          },
          {
            type: 'paragraph',
      ...
      },
      {
        ...
        blocks: [
          {
            type: 'paragraph',
            text: 'החופש בבית הספר הוא חופש בתוך מסגרת. הגבולות נקבעים על ידי חוקי הפרלמנט וחוקי המדינה (כמו איסור עישון בתוך מוסד חינוכי), והם חלים על כולם באופן שווה..',
          },
          {
            type: 'paragraph',
            text: 'לצד חוקים אלו, מתקיים עקרון ההסכמה המשותפת. לדוגמה: בתחילת השנה, המורה והתלמידים קובעים יחד את חוקי השיעור. אם תלמיד מפר את הכללים שהוסכמו (למשל, מפריע גם לאחר אזהרות), המורה מוסמך להוציאו מהכיתה כדי לאפשר לשיעור להתקיים כפי שהוסכם. הוצאה זו אינה עונש (סמכות הענישה שמורה רק לוועדת משמעת), אלא תוצאה ישירה של הכללים שנקבעו.',
          },
          {
            type: 'paragraph',
      ...
      },
      {
        kind: 'sort',
        id: 'u1-a1',
        heading: 'יחידה 3: משחק מיון רשויות (גרירת היגדים)',
        ...
        items: [
          ...
          { id: 's2', text: 'בחירה או פיטורין של מנהל/ת בית הספר.', bucketId: 'legislative' },
          { id: 's3', text: 'ניהולו השוטף של בית הספר.', bucketId: 'executive' },
          { id: 's4', text: 'קבלת אנשי צוות חדשים לקהילה.', bucketId: 'executive' },
          { id: 's5', text: 'הטלת עונשים (תוצאות) על חברי קהילה שעברו על החוק.', bucketId: 'judicial' },
          { id: 's6', text: 'פסילת חוק פרלמנט שנוגד את החוקה (ועדת ערעורים).', bucketId: 'judicial' },
          { id: 's7', text: 'קביעת הגובה המקסימלי של שכר הלימוד.', bucketId: 'association' },
          { id: 's8', text: 'הבטחת קיום בית הספר כדמוקרטי "מכאן ולעולם".', bucketId: 'association' },
        ],
    ...
    slides: [
      {
        ...
        blocks: [
          {
            type: 'paragraph',
            text: 'לאחר שהבנו כיצד הילדים לומדים, מי מלווה אותם ואיך הקהילה מנהלת את עצמה - נותר המעגל האחרון והחשוב ביותר שמחבר את הכל: אתם, ההורים. בדמוקרטי, השותפות שלכם היא חלק בלתי נפרד מהצלחת המודל החינוכי.',
          },
          {
            type: 'list',
            items: [
              'אחריות על הלמידה: האחריות על למידת הילד היא משותפת לילד ולהוריו. מעורבות הורים נחשבת למפתח להצלחה, כאשר היא נעשית מתוך מקום של נוכחות וידיעה, ולא מתוך פיקוח.',
              'הערכה מעצבת: ההערכה בבית הספר היא אישית ומעצבת. היא אינה מספרית או תחרותית, אלא בוחנת את התקדמות הילד ביחס לעצמו (למעט במסגרת הלמידה לבגרות). פעמיים בשנה נפגשים התלמיד והוריו עם החונך לדיון על הערכות התלמיד והצוות לגבי התפקודים הלימודיים, החברתיים והרגשיים. שיח זה מאפשר להורים לקחת חלק פעיל בדיוק המטרות האישיות ודרכי הלמידה של ילדם.',
              'יוזמה הורית: הורים מוזמנים להיות מעורבים באופן פעיל, בועדות, פרלמנטים, הדרכת קורס בהתנדבות ועוד.',
              'חובות ההורים: אחריות לצרכי הילד, דיאלוג רצוף עם הילד והחונך ותשלום שכר הלימוד (הנקבע על ידי העמותה). מקור המימון העיקרי של בית הספר הוא תקצוב משרד החינוך (כ-60%-70% מהתקציב). תשלומי ההורים הם רק אחד מארבעה מקורות מימון.',
            ],
          },
        ],
      },
